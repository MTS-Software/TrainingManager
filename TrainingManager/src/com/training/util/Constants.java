...
public class Constants {
	...
	public final static int PROGRESSINDICATOR_SIZE = 300;

	public static final String SPLASHSCREEN_IMAGE_PROCESSMANAGER = "com/training/resource/icons/splash.png";
	public final static int SPLASH_WIDTH = 1200;
	public final static int SPLASH_HEIGHT = 400;
