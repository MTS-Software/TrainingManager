...
public class AnlageMitarbeiterOverviewController {
	...
	private void showDetails(Anlage data) {
		...
		anlageMitarbeiterDataController.setEditable(false);
	}
	...
	private boolean showEditDialog(Anlage data) {
		try {
			...
			loader.setLocation(Main.class.getResource("view/anlagemitarbeiter/AnlageMitarbeiterEdit.fxml"));
			...
			dialogStage.setTitle("Anlagen - Mitarbeiter: Bearbeiten");

			Scene scene = new Scene(page);
			scene.getStylesheets().add(Constants.STYLESHEET);
			dialogStage.setScene(scene);

			AnlageMitarbeiterEditController controller = loader.getController();
